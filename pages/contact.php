...
<!-- Side Nav -->
<div class="uk-width-1-3@m uk-padding-large uk-float-left uk-text-center contact-side-container uk-visible@m uk-animation-slide-left uk-animation-fast" uk-height-viewport>
    <!-- Close Button -->
    <button class="contact-close uk-position-fixed uk-border-circle" uk-icon="icon: close; ratio: 1.5"></span></button>
	<!-- Contact Info Container -->
	<div class="uk-width-1-2@s uk-width-4-5@m uk-width-3-5@xl uk-position-center uk-padding">
		<h1 class="uk-text-bold proj-name contact-title"></h1> <!-- Contact Title -->
		<p class="proj-description"></p> <!-- Contact Info -->
	</div>
</div>
